...
public class ProduitServiceImpl implements ProduitService {
	...
	//Injection de dependance PAR CONSTRUCTEUR
        //@Autowired
        // final => le rendre inumable (empêche juste de réassigner produitRepository après sa première initialisation (généralement faite dans le constructeur, via l'injection de dépendance Spring))
